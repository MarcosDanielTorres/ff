internal void 
draw_bitmap(OS_PixelBuffer *buffer, i32 x, i32 y, Bitmap bitmap) 
{
...
internal void
draw_rect(OS_PixelBuffer* buffer, i32 dest_x, i32 dest_y, i32 width, i32 height, u32 color) 
{
...
internal void
draw_text(OS_PixelBuffer *buffer, i32 x, i32 y, char* text, FontGlyph* font_table)
{
    u32 line_offset = x;
    for(char* c = text; *c != '\0'; c++)
    {
        ...
        draw_bitmap(buffer,  glyph->bitmap_left + line_offset, y - glyph->bitmap_top, glyph->bitmap);
