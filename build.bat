...
set compile_flags=
set compile_flags=-MDd -std:c++20 -nologo /EHsc %inc_files% -Zi -Od
...
if "%vulkan%"=="1"              %compile% ..\src\samples\vulkan\vulkan.cpp /link /INFERASANLIBS /LIBPATH:%freetype_lib_path% libfreetype.lib user32.lib gdi32.lib comdlg32.lib glslangd.lib glslang-default-resource-limitsd.lib SPIRVd.lib spirv-reflect-staticd.lib
popd