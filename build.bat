...
if "%openglrewrite%"=="1"       %compile% -Fmmain.map ..\src\samples\opengl\maain.cpp /I%VULKAN_SDK%\Include /link opengl32.lib gdi32.lib user32.lib 

@rem "This is with assimp painful as fuck"
@rem if "%openglrewrite%"=="1"       %compile% -Fmmain.map ..\src\samples\opengl\maain.cpp /I%VULKAN_SDK%\Include /link opengl32.lib gdi32.lib user32.lib 
popd